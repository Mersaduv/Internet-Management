...
class AppLocalizations {
  ...
  // 语言相关
  String get language => locale.languageCode == 'en' ? 'Language' : 'زبان برنامه';
  ...
  // 应用标题
  String get appTitle => locale.languageCode == 'en' ? 'Internet Management' : 'مدیریت انترنت';

  // 设置页面
  String get settings => locale.languageCode == 'en' ? 'Settings' : 'تنظیمات';
  String get appSettings => locale.languageCode == 'en' ? 'App Settings' : 'تنظیمات برنامه';
  String get connectionSettings => locale.languageCode == 'en' ? 'Connection Settings' : 'تنظیمات اتصال';
  ...
  String get lightMode => locale.languageCode == 'en' ? 'Light Mode' : 'حالت روشن';
  String get darkModeText => locale.languageCode == 'en' ? 'Dark Mode' : 'حالت تاریک';
  String get followSystem => locale.languageCode == 'en' ? 'Follow System' : 'پیروی از سیستم';
  ...
  String get saveSettings => locale.languageCode == 'en' ? 'Save Settings' : 'ذخیره تنظیمات';
  String get saving => locale.languageCode == 'en' ? 'Saving...' : 'در حال ذخیره...';
  ...
  String get yourDeviceIP => locale.languageCode == 'en'
      ? 'Your Device IP'
      : 'IP دستگاه شما';
  ...
  String get approveDevice => locale.languageCode == 'en' ? 'Approve Device' : 'تایید دستگاه';
  String get rejectDevice => locale.languageCode == 'en' ? 'Reject Device' : 'رد دستگاه';
  String get approveDeviceConfirm => locale.languageCode == 'en'
      ? 'Do you want to approve device "{device}"?\n\nThis device will be able to connect to the network and use the internet.'
      : 'آیا می‌خواهید دستگاه "{device}" را تایید کنید؟\n\nاین دستگاه می‌تواند به شبکه متصل شود و از انترنت استفاده کند.';
  String get rejectDeviceConfirm => locale.languageCode == 'en'
      ? 'Do you want to reject device "{device}"?\n\nThis device will be banned and removed from the network.'
      : 'آیا می‌خواهید دستگاه "{device}" را رد کنید؟\n\nاین دستگاه مسدود خواهد شد و از شبکه حذف می‌شود.';
  ...
  String get deviceRejected => locale.languageCode == 'en'
      ? 'Device rejected and banned'
      : 'دستگاه رد شد و مسدود شد';
  ...
  String get bannedDevice => locale.languageCode == 'en' 
      ? 'Banned Device' 
      : 'دستگاه مسدود شده';
  String get unbanDevice => locale.languageCode == 'en' ? 'Unban Device' : 'رفع مسدودیت دستگاه';
  ...
  String get autoBanned => locale.languageCode == 'en'
      ? 'Auto-banned (New connection lock)'
      : 'مسدود خودکار (قفل اتصال جدید)';
  String get manualBanned => locale.languageCode == 'en' 
      ? 'Manual Ban' 
      : 'مسدود دستی';
  ...
  // 通用
  String get loading => locale.languageCode == 'en' ? 'Loading...' : 'در حال بارگذاری...';
  ...
  String get selected => locale.languageCode == 'en' ? 'Selected' : 'انتخاب شده';
  String get all => locale.languageCode == 'en' ? 'All' : 'همه';
  String get none => locale.languageCode == 'en' ? 'None' : 'هیچکدام';

  // 辅助方法
  String approveDeviceConfirmWithDevice(String device) {
    return approveDeviceConfirm.replaceAll('{device}', device);
  }

  String rejectDeviceConfirmWithDevice(String device) {
    return rejectDeviceConfirm.replaceAll('{device}', device);
  }
  ...
  String get deviceName => locale.languageCode == 'en' ? 'Device Name' : 'نام دستگاه';
  String get deviceInformation => locale.languageCode == 'en' ? 'Device Information' : 'اطلاعات دستگاه';
  String get operations => locale.languageCode == 'en' ? 'Operations' : 'عملیات';
  String get type => locale.languageCode == 'en' ? 'Type' : 'نوع';
  String get ipAddress => locale.languageCode == 'en' ? 'IP Address' : 'آدرس IP';
  String get macAddress => locale.languageCode == 'en' ? 'MAC Address' : 'آدرس MAC';
  String get hostname => locale.languageCode == 'en' ? 'Hostname' : 'نام میزبان';
  String get connectionTime => locale.languageCode == 'en' ? 'Connection Time' : 'زمان اتصال';
  String get signalStrength => locale.languageCode == 'en' ? 'Signal Strength' : 'قدرت سیگنال';
  String get speedLimit => locale.languageCode == 'en' ? 'Speed Limit' : 'محدودیت سرعت';
  String get setSpeedLimit => locale.languageCode == 'en' ? 'Set Speed Limit' : 'تنظیم سرعت';
  String get downloadSpeed => locale.languageCode == 'en' ? 'Download Speed' : 'سرعت دانلود';
  String get uploadSpeed => locale.languageCode == 'en' ? 'Upload Speed' : 'سرعت آپلود';
  ...
  String get unitGuide => locale.languageCode == 'en' ? 'Unit Guide:' : 'راهنمای واحدها:';
  ...
  String get errorSettingSpeed => locale.languageCode == 'en'
      ...
      : 'خطا در تنظیم سرعت';
  String get banDevice => locale.languageCode == 'en' ? 'Ban Device' : 'مسدود کردن';
  ...
  String get makeStaticConfirm => locale.languageCode == 'en'
      ...
      : 'آیا مطمئن هستید که می‌خواهید دستگاه {ip} را Static کنید؟';
  String get makeStaticTitle => locale.languageCode == 'en'
      ? 'Make Device Static'
      : 'Static کردن دستگاه';
  String get deviceMadeStatic => locale.languageCode == 'en'
      ? 'Device made static successfully'
      : 'دستگاه با موفقیت Static شد';
  String get errorMakingStatic => locale.languageCode == 'en'
      ? 'Error making device static'
      : 'خطا در Static کردن دستگاه';
  String get connectionNotEstablished => locale.languageCode == 'en'
      ? 'Connection not established'
      : 'اتصال برقرار نشده';
  String get makeStaticTimeout => locale.languageCode == 'en'
      ? 'Make static timeout. Please try again.'
      : 'زمان تبدیل به Static به پایان رسید. لطفاً دوباره تلاش کنید.';
  String get returnToDynamic => locale.languageCode == 'en' ? 'Return to Dynamic' : 'برگشت به Dynamic';
  String get returnToDynamicConfirm => locale.languageCode == 'en'
      ? 'Are you sure you want to return device {ip} to dynamic?'
      : 'آیا مطمئن هستید که می‌خواهید دستگاه {ip} را به Dynamic تبدیل کنید؟';
  String get returnToDynamicTitle => locale.languageCode == 'en'
      ? 'Return to Dynamic'
      : 'برگشت به Dynamic';
  String get deviceReturnedToDynamic => locale.languageCode == 'en'
      ? 'Device returned to dynamic successfully'
      : 'دستگاه با موفقیت به Dynamic تبدیل شد';
  String get errorReturningToDynamic => locale.languageCode == 'en'
      ? 'Error returning device to dynamic'
      : 'خطا در برگشت به Dynamic';
  String get returnToDynamicTimeout => locale.languageCode == 'en'
      ? 'Return to dynamic timeout. Please try again.'
      : 'زمان برگشت به Dynamic به پایان رسید. لطفاً دوباره تلاش کنید.';
  // 返回Dynamic的说明信息
  String get returnToDynamicInfo1 => locale.languageCode == 'en'
      ? '• Static Lease will be removed'
      : '• Static Lease حذف خواهد شد';
  String get returnToDynamicInfo2 => locale.languageCode == 'en'
      ? '• After removal, if the device is still connected and requests DHCP, an address will be assigned from the dynamic pool'
      : '• پس از حذف، اگر دستگاه هنوز متصل باشد و DHCP درخواست کند، آدرس از pool پویا اختصاص داده می‌شود';
  String get returnToDynamicInfo3 => locale.languageCode == 'en'
      ? '• IP address may change'
      : '• آدرس IP ممکن است تغییر کند';
  String get socialMediaFilter => locale.languageCode == 'en'
      ? 'Social Media Filter'
      : 'فیلتر شبکه‌های اجتماعی';
  String get filterEnabled => locale.languageCode == 'en'
      ? 'Filter {platform} enabled'
      : 'فیلتر {platform} فعال شد';
  String get filterDisabled => locale.languageCode == 'en'
      ? 'Filter {platform} disabled'
      : 'فیلتر {platform} غیرفعال شد';
  String get errorChangingFilter => locale.languageCode == 'en'
      ? 'Error changing filter status'
      : 'خطا در تغییر وضعیت فیلتر';
  // 社交媒体平台名称
  String get telegram => locale.languageCode == 'en' ? 'Telegram' : 'تلگرام';
  String get youtube => locale.languageCode == 'en' ? 'YouTube' : 'یوتیوب';
  String get instagram => locale.languageCode == 'en' ? 'Instagram' : 'اینستاگرام';
  String get facebook => locale.languageCode == 'en' ? 'Facebook' : 'فیسبوک';
  // Lease状态
  String get leaseStatus => locale.languageCode == 'en' ? 'Lease Status' : 'وضعیت Lease';
  String get thisDeviceIsBanned => locale.languageCode == 'en'
      ? 'This device is banned'
      : 'این دستگاه مسدود شده است';
  String get staticLease => locale.languageCode == 'en' ? 'Static (Static)' : 'Static (ثابت)';
  String get dynamicLease => locale.languageCode == 'en' ? 'Dynamic (Dynamic)' : 'Dynamic (پویا)';
  String get removeFromAllowedList => locale.languageCode == 'en'
      ? 'Remove from Allowed List'
      : 'Remove from Allowed List';
  String get allowDevice => locale.languageCode == 'en' ? 'Allow Device' : 'Allow Device';
  String get errorRemovingFromAllowed => locale.languageCode == 'en'
      ? 'Error removing from allowed list'
      : 'خطا در حذف از لیست مجاز';
  String get errorAllowingDevice => locale.languageCode == 'en'
      ? 'Error allowing device'
      : 'خطا در اجازه دادن به دستگاه';
  String get deviceWithIP => locale.languageCode == 'en'
      ? 'Device {ip}'
      : 'دستگاه {ip}';
  String get deviceWithMAC => locale.languageCode == 'en'
      ? 'Device {mac}'
      : 'دستگاه {mac}';
  ...
  String get bannedDeviceText => locale.languageCode == 'en'
      ? 'Banned Device'
      : 'دستگاه مسدود شده';
  String get unbanDeviceTooltip => locale.languageCode == 'en'
      ? 'Unban Device'
      : 'رفع مسدودیت';
  ...
  String makeStaticConfirmWithIP(String ip) {
    return makeStaticConfirm.replaceAll('{ip}', ip);
  }

  String returnToDynamicConfirmWithIP(String ip) {
    return returnToDynamicConfirm.replaceAll('{ip}', ip);
  }

  String filterEnabledWithPlatform(String platform) {
    return filterEnabled.replaceAll('{platform}', platform);
  }

  String filterDisabledWithPlatform(String platform) {
    return filterDisabled.replaceAll('{platform}', platform);
  }
  ...
  String get deviceRemovedFromStatic => locale.languageCode == 'en'
      ? 'Static Lease removed successfully. Device is now Dynamic.'
      : 'Static Lease با موفقیت حذف شد. دستگاه اکنون Dynamic است.';
  // Static/Dynamic Lease 操作消息
  String get leaseAlreadyStatic => locale.languageCode == 'en'
      ? 'This lease is already static'
      : 'این Lease قبلاً Static است';
  String get staticLeaseCreatedSuccessfully => locale.languageCode == 'en'
      ? 'Static Lease created successfully'
      : 'Static Lease با موفقیت ایجاد شد';
  String get leaseAlreadyDynamic => locale.languageCode == 'en'
      ? 'This lease is already dynamic'
      : 'این Lease قبلاً Dynamic است';
  String get staticLeaseRemovedSuccessfully => locale.languageCode == 'en'
      ? 'Static Lease removed successfully. Device is now Dynamic.'
      : 'Static Lease با موفقیت حذف شد. دستگاه اکنون Dynamic است.';
  String get staticLeaseRemovedNote => locale.languageCode == 'en'
      ? 'After removal, if the device is still connected and requests DHCP, an address will be assigned from the dynamic pool.'
      : 'بعد از حذف، اگر دستگاه هنوز متصل باشد و درخواست DHCP بدهد، آدرس از استخر دینامیک اختصاص داده می‌شود.';
  // 辅助方法
  ...
  String localizeServiceMessage(String message) {
    // 检查是否是服务层返回的硬编码消息
    if (message.contains('این Lease قبلاً Static است') || message.contains('This lease is already static')) {
      return leaseAlreadyStatic;
    }
    if (message.contains('Lease با موفقیت به Static تبدیل شد') || message.contains('Static Lease با موفقیت ایجاد شد') || message.contains('Static Lease created successfully') || message.contains('Lease successfully converted to Static')) {
      return staticLeaseCreatedSuccessfully;
    }
    if (message.contains('این Lease قبلاً Dynamic است') || message.contains('This lease is already dynamic')) {
      return leaseAlreadyDynamic;
    }
    if (message.contains('Static Lease با موفقیت حذف شد') || message.contains('Static Lease removed successfully')) {
      return staticLeaseRemovedSuccessfully;
    }
    if (message.contains('بعد از حذف، اگر دستگاه هنوز متصل باشد') || message.contains('After removal, if the device is still connected')) {
      return staticLeaseRemovedNote;
    }
    // 如果不是已知消息，尝试作为错误消息处理
  ...
  String localizeServiceError(String errorMessage) {
    if (errorMessage.contains('خطا در اتصال') || errorMessage.contains('Connection error')) {
      return connectionError;
    }
    if (errorMessage.contains('اتصال برقرار نشده') || errorMessage.contains('Connection not established')) {
      return connectionNotEstablishedError;
    }
    if (errorMessage.contains('آدرس IP دستگاه الزامی است') || errorMessage.contains('Device IP address is required')) {
      return deviceIpRequired;
    }
    if (errorMessage.contains('پلتفرم نامعتبر') || errorMessage.contains('Invalid platform')) {
      final match = RegExp(r'پلتفرم نامعتبر:\s*(.+)|Invalid platform:\s*(.+)').firstMatch(errorMessage);
      if (match != null) {
    ...
    if (errorMessage.contains('خطا در ویرایش queue') || errorMessage.contains('Error editing queue')) {
      final match = RegExp(r'خطا در ویرایش queue:\s*(.+)|Error editing queue:\s*(.+)').firstMatch(errorMessage);
      if (match != null) {
    ...
    if (errorMessage.contains('خطا در ایجاد queue') || errorMessage.contains('Error creating queue')) {
      final match = RegExp(r'خطا در ایجاد queue:\s*(.+)|Error creating queue:\s*(.+)').firstMatch(errorMessage);
      if (match != null) {
        final error = match.group(1) ?? match.group(2) ?? '';
    ...
    if (errorMessage.contains('خطا در تنظیم سرعت') || errorMessage.contains('Error setting speed')) {
      final match = RegExp(r'خطا در تنظیم سرعت:\s*(.+)|Error setting speed:\s*(.+)').firstMatch(errorMessage);
      if (match != null) {
        final error = match.group(1) ?? match.group(2) ?? '';
    ...
    if (errorMessage.contains('Timeout') || errorMessage.contains('timeout')) {
      if (errorMessage.contains('ویرایش queue') || errorMessage.contains('editing queue')) {
        return queueEditTimeout;
      }
      if (errorMessage.contains('ایجاد queue') || errorMessage.contains('creating queue')) {
